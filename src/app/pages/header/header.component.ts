...
export class HeaderComponent implements OnInit {
  ...
  get selectedTopic() {
    return this.themeService.getSelectedTopic();
  }

  get selectedTopicIcon(): SafeHtml | null {
    return this.selectedTopic ? this.selectedTopic.icon : null;
  }

  get selectedTopicBgColor(): string {
    return this.selectedTopic ? this.selectedTopic.bgColor : 'transparent';
  }
}
